...
export default class NewTransaksiKasir extends Component {
  constructor() {
    super();
    this.state = {
      id_member: 0,
  ...
  render() {
    return (
      <div className="container d-flex justify-content-center">
        <div className="card my-4 col-lg-6 col-md-10 col-sm-10">
        <Button className="btn btn-success mt-3 mb-5 mx-4" href="/transaksi.kasir">
          Back to list
        </Button>
