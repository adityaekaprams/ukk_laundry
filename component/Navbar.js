        ...
        <div class="container-lg">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-dark" href="/member">MEMBER</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-dark" href="/outlet">OUTLET</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-dark" href="/transaksi">TRANSAKSI</a>
                    </li>
                    {/* <li class="nav-item">
                        <a class="nav-link text-dark" href="/laporanAdmin">LAPORAN</a>
                    </li> */}
                    <li class="nav-item">
