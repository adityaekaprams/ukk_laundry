                ...
                <Container className="my-4">
                    ...
                    <Card className="card shadow">
                        ...
                        <Card.Body className="card-body">
                            ...
                            <div className="">
                                <center>
                                {/* <Button className="btn btn-dark btn-lg btn-block my-3 mx-3" href="/FormTransaksiKasir">
                                    ADD TRANSAKSI
                                </Button>
                                <Button className="btn btn-dark btn-lg btn-block my-3 mx-3" href="/laporanKasir">
                                    REPORT TO PDF
                                </Button> */}
                                </center>
                            </div>
